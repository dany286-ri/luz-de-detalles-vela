...
export default function WhatsAppFloatButton() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 w-14 h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-soft hover:scale-105 transition-transform duration-200"
    >
